...
# получили всю информацию по городам с сайта афиши
# записали информацию в базу(только уникальные города, название города уникальное поле)
#
# город - метро - кт metro2theater
# город 1:M метро / метро M:M кт
